    ...
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var config = new ConfigurationBuilder()
               .SetBasePath(AppContext.BaseDirectory) // Ensures it reads from current folder
            ...
            // ✅ Pass configuration into EmailService
            var emailService = new EmailService(config);
            emailService.SendEmail("Xanne", emailInput);

            Console.WriteLine($"📧 Test email sent successfully to {emailInput} via Mailtrap!");

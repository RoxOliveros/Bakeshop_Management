...
namespace Bakeshop_DataLogic
{
    public class JsonFileBakeshopDataSource : IBakeshopDataService
    {
        ...
        private void LoadAccounts()
        {
            ...
            catch { Accounts = new List<CustomerAccount>(); }
        }
        ...
        private void LoadMenu()
        {
            ...
            catch { Menu = new List<(string, decimal)>(); }
        }
        ...
        public CustomerAccount GetCustomerById(int userId) => Accounts.ElementAtOrDefault(userId);
